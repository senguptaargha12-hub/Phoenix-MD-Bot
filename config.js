...
//____________________________________________________________________________________________________________________________________________  
  //🤖 BOT CONFIGURATION
  SESSION_ID: process.env.SESSION_ID || 'Phoenix~VividCobalt',
  STICKER_DATA: process.env.STICKER_DATA || '🎯ᴘʜᴏᴇɴɪx-ᴍᴅ;ᴀrgha sengupta',
  ...
  SUDO: process.env.SUDO || '9330766369',
  ...
  HEROKU_APP_NAME: process.env.HEROKU_APP_NAME || 'Argha sengupta',
